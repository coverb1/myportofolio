...
<div className='visit-instagram-paragraph'
onMouseEnter={()=>setshowplatforms(true)}
onMouseLeave={()=>setshowplatforms(false)}
>
  <p>
    Many projects visit my platforms</p>

    {showplatforms &&(
      <ul className='platform-container'>
        <li>
          <a href="https://www.upwork.com/freelancers/~017993c249ae77b5b0?mp_source=share">Upwork</a>
          </li>
          <li>
